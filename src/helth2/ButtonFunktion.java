...
public class ButtonFunktion {
	...
	public static void involvedButton() {
		...
		Label ageLabel = new Label("Věk:");
		GridPane.setConstraints(ageLabel, 0, 0);

		ageInput = new TextField("věk");
...
// 		zkontorlovat jestli je to float, zkontrolovat 3 hodnoty-musí být rozdílný od 0
